...
//Преобразование XPM-файла текстуры в изображение (последовательность чисел)
...
//Считывание строки с адресом файла текстуры
...
//Преобразование строки цвета в число цвета
...
//Накопление массива "all->map.tab" строками карты
